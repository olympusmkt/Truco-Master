        ...
        <div class="uk-grid" uk-grid style="align-items: center;">
            <div class="uk-width-1-2@s">
                <div class="line-section-list">
                    <h1 style="margin-top: 0em; margin-bottom: 0em;" class="title-dash-admin-draken">Listagem de Administradores</h1>
                    <p style="margin-top: 0em; margin-bottom: 0em;">Gostaria de editar ou ver os detalhes de algum administrador?</p>
                </div>
            </div>
        ...
        <table id="example" class="uk-table uk-table-hover uk-table-striped" style="width:100%">
            ...
            @foreach ($select_users as $post)
                <tr>
                    ...
                    <td><a href="administrador/{{ $post->id }}"><span class="uk-badge" style="text-transform: uppercase;">Editar Administrador</span></a></td>
                </tr>
            @endforeach
            </tbody>
        </table>
