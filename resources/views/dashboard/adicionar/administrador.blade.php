...
@section('content')
    <div>
        <div>
            <h1 style="margin-top: 0em; margin-bottom: 0em;" class="title-dash-admin-draken">Adicionar Administrador</h1>
            <p style="margin-top: 0em;">Gostaria de adicionar algum administrador?</p>
        </div>
        <hr>
        <div>
            <div>
                <div class="uk-card uk-card-default uk-card-body">
                    <form>
                        ...
                        <div class="uk-margin">
                            <button type="submit" id="btn-submit" class="uk-button uk-button-primary uk-width-1-1">Adicionar Administrador</button>
                        </div>
                    </form>
                </div>
            </div>
